...
class JmfGridBundle extends AbstractBundle
{
    ...
    public function __construct(
        private readonly GridConfigurationLoader $gridConfigurationLoader = new GridConfigurationLoader(),
    ) {
    }
    ...
    public function loadExtension(
        ...
        $config['grids'] = $this->gridConfigurationLoader->load($config, $builder, $this->extensionAlias);
